 ...
 * @author Paul
 */
public class AddAndEditEmployeeModal extends javax.swing.JFrame {
     ...
     */
    public AddAndEditEmployeeModal() {
        ...
        TableCellRender tableActionCellRenderTest = new TableCellRender(new PanelActionButtons());
        add_employee_table
                .getColumnModel()
                .getColumn(2)
        ...
        TableEmployeeActionEvent event = new TableEmployeeActionEvent() {
            ...
            public void onAddIncome(int row) {
                ...
                AddAndEditEmployeeModal.this.dispose();
            }
