 ...
 * @author Paul
 */
public class RightRoundedCornerPanel extends javax.swing.JPanel {

    /**
     * Creates new form PanelBorder
     */
    public RightRoundedCornerPanel() {
        initComponents();
        setOpaque(false);
    ...
    protected void paintComponent(Graphics graphics) {
        ...
        GradientPaint gradientPaint = new GradientPaint(0, 0, Color.decode("#7cb1e7"), 0, getHeight(), Color.decode("#9126ef"));
