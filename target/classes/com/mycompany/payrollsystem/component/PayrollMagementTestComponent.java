 ...
 * @author Paul
 */
public class PayrollMagementTestComponent extends javax.swing.JPanel {
    ...
    public PayrollMagementTestComponent() {
    ...
    private void init() {
        ...
        TableGroupActionEvent event = new TableGroupActionEvent() {
            ...
            public void onProcessTimecard(int row) {
                ...
                choice = JOptionPane.showOptionDialog(
                        PayrollMagementTestComponent.this,
                        "Process Timecard?", 
                        "Payroll", 
        ...
        TableActionCellRenderTest tableActionCellRender = new TableActionCellRenderTest(new PanelGroupAction());
        payroll_management_table.getColumnModel().getColumn(5).setCellRenderer(tableActionCellRender);
        payroll_management_table.getColumnModel().getColumn(5).setCellEditor(new TableActionCellEditorTest<>(new PanelGroupAction(), event));
