 ...
 * @param <T>
 */
public class TableActionCellEditorTest<T extends JComponent, E> extends DefaultCellEditor {
    
    private final T actionComponent;
    private final E event;
    
    public TableActionCellEditorTest(T actionComponent, E event) {
        super(new JCheckBox());
    ...
    public Component getTableCellEditorComponent(JTable table, Object value, boolean isSelected, int row, int column) {
        ...
        if (actionComponent instanceof PanelEditAction panelEditAction) {
            ...
            panelActionButtons.initEvent((EmployeeActionListener) event, row);
